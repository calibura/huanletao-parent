...
import com.huanletao.sellergoods.service.GoodsDescService;
...
public class GoodsDescController {
	 ...
	 */
	@RequestMapping("/add")
	public JsonResult add(@RequestBody TbGoodsDesc goodsDesc){
		try {
	...
	public JsonResult update(@RequestBody TbGoodsDesc goodsDesc){
		try {
