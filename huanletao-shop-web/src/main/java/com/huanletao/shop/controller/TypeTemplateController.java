...
import com.huanletao.pojo.TbTypeTemplate;
import com.huanletao.sellergoods.service.TypeTemplateService;
...
public class TypeTemplateController {
	...
	public JsonResult update(@RequestBody TbTypeTemplate typeTemplate){
		try {
